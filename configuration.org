...
(defvar +scala/common-imports
  '("import scala.concurrent.duration._"
    ...
    "import cats.implicits.functor._"
...
** RSVP
#+begin_src emacs-lisp :results none
(defvar rsvp/wait-for-seconds 0.25)
...
(defun rsvp/read-from-ocr ()
  ...
  (with-current-buffer (or (get-file-buffer rsvp/text-buffer-name)
	             	   (find-file-noselect rsvp/text-buffer-name))
    (erase-buffer)
    (+ocr/screenshot)
