...
(defun my-org-screenshot-take (width)
  ...
  (let* ((name (generate-file-name (org-screenshot-image-directory)))
...
* Temporary
#+begin_src emacs-lisp :results none
(load "/home/porcupine/.emacs.d/elpa/smartparens-20201113.951/smartparens")
#+end_src
