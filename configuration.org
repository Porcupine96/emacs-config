...
Font.
#+begin_src emacs-lisp :results none
(set-face-attribute 'default nil :font "Roboto Mono for Powerline-12")
(set-face-attribute 'fixed-pitch nil :font "Roboto Mono for Powerline-12")
...
(defhydra hydra-dired-bookmarks (:color blue)
  ...
  ("c" (lambda () (interactive) (dired "~/studies/sem6/")))
...
(use-package org
  ...
  (defun +latex-rescale ()
    ...
    (plist-put (plist-put org-format-latex-options :background "#282a36")
               :scale (if (= (x-display-pixel-width) 1920) 1.2 2.5))
...
" )))
  ...
  (:map evil-normal-state-map
        ("C-z t l" . +zowie/to-jira-org-link) ;; TODO: use general instead?
        ("C-c h" . org-toggle-heading)
        ("C-k" . evil-window-up)
        ("C-j" . evil-window-down)
	:map org-mode-map 
        ("C-z t l" . +zowie/to-jira-org-link)
        ("C-c h" . org-toggle-heading)
...
(use-package general
  ...
  (leader-def
    ...
    "f x" (lambda () (interactive)(find-file "~/.config/sway/config"))
